...
export class RoomsComponent implements OnInit{
  ...
  public loadData() {
    this.exampleDatabase = new RoomService(this.httpClient, this.afs);
  ...
  exportExcel() {
    ...
    const exportData: Partial<TableElement>[] =
      this.dataSource.filteredData.map((x) => ({
        ...
        'AC/Non AC': x.acNonac,
        Meal: x.meal,
        'Bed Capacity': x.capacity,
        'Retail Price': x.retailPrice,
    ...
    return data.sort((a, b) => {
      ...
      switch (this._sort.active) {
        ...
        case 'retailPrice':
          ...
          break;
        case 'discountAmount':
          [propertyA, propertyB] = [a.discountAmount, b.discountAmount];
          break;
      }
